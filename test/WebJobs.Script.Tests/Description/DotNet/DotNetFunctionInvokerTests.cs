...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class DotNetFunctionInvokerTests
    {
        ...
        public async Task CompilerError_IsRetried_UpToLimit()
        {
            ...
            compilationFactory
                .Setup(f => f.CreateService(ScriptTypes.CSharp, It.IsAny<IFunctionMetadataResolver>()))
        ...
        private RunDependencies CreateDependencies(Action<IServiceCollection> configureServices = null)
        {
            ...
            compilationServiceFactory.Setup(f => f.CreateService(ScriptTypes.CSharp, It.IsAny<IFunctionMetadataResolver>()))
