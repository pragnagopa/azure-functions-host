...
namespace Microsoft.Azure.WebJobs.Script.Tests.Rpc
{
    public class FunctionDispatcherTests
    {
        ...
        private static IFunctionDispatcher GetTestFunctionDispatcher()
        {
            ...
            return new FunctionDispatcher(scriptOptions, metricsLogger.Object, testEnv, eventManager.Object, loggerFactory, new OptionsWrapper<LanguageWorkerOptions>(workerConfigOptions), languageWorkerChannelManager.Object);
        }
    }
}
