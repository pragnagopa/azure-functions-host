    ...
    public class LanguageWorkerChannel : ILanguageWorkerChannel
    {
        ...
        private void OnProcessExited(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    LanguageWorkerProcessExitException processExitEx = new LanguageWorkerProcessExitException($"{_process.StartInfo.FileName} exited with code {_process.ExitCode}\n {exceptionMessage}");
        ...
        public void CreateWorkerContextAndStartProcess()
        {
      ...
      .Subscribe((msg) => PublishWorkerProcessReadyEvent(msg.Message.FunctionEnvironmentResponse)));
        ...
        public void SendFunctionLoadRequest(FunctionRegistrationContext context)
        {
