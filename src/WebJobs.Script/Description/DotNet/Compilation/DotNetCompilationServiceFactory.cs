...
namespace Microsoft.Azure.WebJobs.Script.Description
{
    ...
    {
        private static readonly ImmutableArray<string> SupportedLanguages = new[] { ScriptTypes.CSharp, ScriptTypes.FSharp, ScriptTypes.DotNetAssembly }.ToImmutableArray();
            ...
            switch (language)
            {
                ...
                default:
                    throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture,
                        "The script type {0} is not supported by the {1}", language, typeof(DotNetCompilationServiceFactory).Name));
            }
        }
    }
}
